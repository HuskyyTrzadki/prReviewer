  ...
  return (
    <section className="ds-section ds-section-muted relative overflow-hidden">
      ...
      <div className="ds-container relative">
        ...
        <div className="space-y-4 pb-8 text-center lg:pb-14 lg:text-left">
          ...
          <ul className="flex flex-wrap justify-center gap-x-5 gap-y-2 text-sm font-medium text-dark-slate lg:justify-start">
            {trustItems.map((item) => (
